...
const AddNewLoanByBorrower = () => {
  ...
  const onClick = useCallback(async () => {
    ...
    try {
      ...
      let borrowerStorageAccount_pk_r = new PublicKey("6VtwpSZvVLmSLUZGo3g3PmpWq4HJSu4Mp1ZPxHMHCTsQ");
      ...
      if (createBorrowerStorageAccountFlag) {
        ...
        createAndInitializeLoanInfoAccountTx.sign(borrowerStorageAccount, loanInfoStorageAccount);


        signature = await sendTransaction(createAndInitializeLoanInfoAccountTx, connection);
